...
export function CpuDie() {
  return (
    <div
      ...
      style={{ background: "linear-gradient(150deg, #1e1e1e 0%, #111 60%, #161616 100%)", border: "1px solid hsla(0, 0%, 100%, 0.11)",
        boxShadow: `inset 0 1px 0 rgba(255,255,255,0.06), inset 0 -1px 0 rgba(0,0,0,0.6), 0 2px 8px rgba(0,0,0,0.7)`,
        padding: "1px",
        minWidth: 380,
      }}
    >
      <div className="relative rounded-sm flex flex-col gap-4 p-5"
        style={{ background: "linear-gradient(160deg, #181818 0%, #0f0f0f 100%)", border: "1px solid hsla(0, 0%, 100%, 0.05)"}}
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-3 h-3 rounded-full"
              style={{ background: "hsla(0, 0%, 100%, 0.12)", border: "1px solid hsla(0, 0%, 100%, 0.18)", boxShadow: "inset 0 1px 0 hsla(0, 0%, 100%, 0.1)"}}
            />
            <span className="font-brains text-xs text-white/25 tracking-[0.2em] uppercase">RS-COMM-01</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-brains text-xs text-white/20 tracking-widest">ACTIVE</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <span className="font-brains text-[10px] text-white/15 tracking-[0.18em]">3 I/O PINS</span>
          <span className="font-brains text-[10px] text-white/15 tracking-[0.18em]">REV 1.0</span>
        </div>
      </div>
    </div>
  )
